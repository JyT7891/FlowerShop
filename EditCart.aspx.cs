...
namespace FlowerShop2
{
    public partial class EditCart : System.Web.UI.Page
    {
        ...
        protected void EditCart_Click(object sender, EventArgs e)
        {
            ...
            {
                string prevProductName = Request.QueryString["ProductName"];
                // You have the ProductName, use it as needed (e.g., display, process data, etc.)
            ...
            int cartID = GetCartID(UserID, prevProductName); // Fetch CartID based on UserID and ProductName
        ...
        private int GetCartID(string userID, string prevProductName)
        {
            int cartID = 0;
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    command.Parameters.AddWithValue("@ProductName", prevProductName);
